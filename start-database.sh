...
DB_CONTAINER_NAME="demo_project-postgres"
...
docker run --name $DB_CONTAINER_NAME -e POSTGRES_PASSWORD=$DB_PASSWORD -e POSTGRES_DB=demo_project -d -p 5432:5432 docker.io/postgres
